...
class BlogAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ...
        ("📊 Metadata", {"fields": ("reading_time",), "classes": ("collapse",)}),
    )
...
class CommentAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ...
        ("✅ Moderation", {"fields": ("is_approved",), "classes": ("wide",)}),
        (
            "📊 Stats",
            {"fields": ("created_date", "like_count"), "classes": ("collapse",)},
        ),
    )
...
class CommentLikeAdmin(admin.ModelAdmin):
    ...
    def comment_preview(self, obj):
        return (
            obj.comment.body[:50] + "..."
            if len(obj.comment.body) > 50
            else obj.comment.body
        )
